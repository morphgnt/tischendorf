...
alternate_Tischendorf_spellings = { "DAUID" : [ "DAUEID" ],
                                    ...
                                    "NEFQALIM" : [ "NEFQALEIM" ],
                                    "ALIEIS" : [ "ALEEIS" ],
                                    "ELQETW" : [ "ELQATW" ], # FIXME: Is this correct?
                                    "DUSIN" : [ "DUSI" ],
                                    ...
                                    "EGKOPHN" : [ "EKKOPHN" ], # This is probably NOT a textual error!
                                    "EGKOPTESQAI" : [ "ENKOPTESQAI" ],
                                    "EGKOPTW" : [ "ENKOPTW" ],
                                    "EGKRINAI" : [ "ENKRINAI" ],
                                    "EIDEN" : [ "IDEN" ],
                                    "ANWRQWQH" : [ "ANORQWQH" ],
                                    "ANOIGHSETAI" : [ "ANOIXQHSETAI" ],
